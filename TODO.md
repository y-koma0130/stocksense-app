...
### マイリスト（フィルターリスト）機能の実装 ✅ 完了
- [x] フィルターリストテーブルの設計・実装 (filter_lists)
- [x] フィルター条件追加・削除API実装 (tRPCルーター)
- [x] マイリスト管理画面の作成 (FilterListPage)
- [x] マイリスト編集ドロワーUI (FilterListEditDrawer)
- [x] 市場・業種・価格帯フィルターの実装
- [x] LINE通知へのフィルター適用
- [x] ダッシュボードへのフィルターリストセレクタ追加
- [x] 共通Selectコンポーネントの作成 (src/components/ui/Select.tsx)
- [x] 最大登録数の制限 (Free: 1件, Standard: 3件, Pro: 10件)
...
### 通知フィルタリング ✅ 完了
- [x] 市場別フィルター (東証プライム、スタンダードなど)
- [x] 業種別フィルター
- [x] 価格帯フィルター
- [x] タグフィルター (マクロタグ、テーマタグ) - Backend API のみ
- [x] フィルター適用ロジックの実装
- [x] フィルター設定画面の作成 (マイリスト)
- [x] 保存した設定の管理 (マイリスト)
- [x] フィルター設定の保存 (filter_lists テーブル)
- [ ] スコア範囲フィルター (将来検討)
