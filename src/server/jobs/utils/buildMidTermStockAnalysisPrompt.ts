...
## 検索すべき情報（優先度順）
1. 直近1ヶ月以内の決算発表・業績修正
2. 直近1ヶ月以内のIR・プレスリリース
3. セクター全体に影響する政策・規制の動き
4. 突発的なリスク（不祥事、訴訟、事故、行政処分）
...
- 「直近の材料は確認できなかった」旨をsummaryに含めてよい

## 検索結果の信頼性
- 企業公式IR、日経、東洋経済、ロイターなどを優先
- 個人ブログ、掲示板、SNSの情報は参考程度に留める
...
2. investmentPointsの各項目が100字を超えていないか？ → 超えていれば簡潔にまとめる
3. risksの各項目が100字を超えていないか？ → 超えていれば簡潔にまとめる
